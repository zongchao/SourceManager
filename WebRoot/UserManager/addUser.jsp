    ...
    <body>
        <div class="container">
            ...
            <div class="row" style="display:block;">
                <div class="span2">&nbsp;</div>
                <div class="span8">
                    <form action="addUser.action" id="form" class="form-horizontal" method="post">
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="username" name="user.username" class="{required:true}" onblur="checkUsername()"/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="password" id="password" name="user.password" class="{required:true,minlength:5}"/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="password" id="confirm_password" class="{required:true,minlength:5,equalTo:'#password'}"/>
                                </div>
                            </div>
                            <div class="control-group">
