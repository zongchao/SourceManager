    ...
    <body>
        <div class="container">
            ...
            <div class="row" style="display:block;">
                <div class="span2">&nbsp;</div>
                <div class="span8">
                    <form action="addFinance.action" id="form" class="form-horizontal" method="post" enctype="multipart/form-data" >
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                	<div class="input-append">
                                    	...
                                    	<input type="text" id="money" name="finance.money" class="{required:true,number:true}" style="width:179px"/>
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea id="note" name="finance.note" class="" rows="5"></textarea>
                                </div>
                            </div>
